...
export function ComparativoHeroKPI({ data }: Props) {
  return (
    <div className="rounded-2xl border border-primary/15 bg-gradient-to-br from-primary/5 via-background to-primary/10 p-8 sm:p-10 text-center animate-fade-in shadow-lg">
